    ...
    <Container style={{ backgroundColor: 'white', color: '#505050' }} className='p-3'>
      <div className='row mb-3 '>
        <div className='col-lg-2 mt-2'>
          ...
          <div className='col-lg-2 mt-2 d-flex align-items-center'>
...
<div className='col-lg-4 d-flex mt-2 align-items-center'>
<Form.Select  style={{ width: 'auto', height: '36px' }} aria-label="Status">
            <option value=''>Status All:</option>
            <option value="Status">Status</option>
          </Form.Select>
          <Form.Select className='mx-1' style={{ width: 'auto', height: '36px' }} aria-label="District">
            <option value=''>State All:</option>
            <option value="District">District</option>
          </Form.Select>
</div>

        <div className='col-lg-3 d-flex mt-2 align-items-end'>
          <Form.Control
            id="Search"
            type="text"
            placeholder="Search"
        ...
        <Table bordered hover responsive>
          <thead>
            <tr>
              ...
              <th style={{ color: '#505050' }}>State</th>
      ...
      <td style={{ color: '#203583' }}>    <a href="Volunteerview">  <IoEyeSharp /> </a></td>
